# Formularium (Omeka S module)

[Formularium](https://github.com/biblibre/omeka-s-module-Formularium) is a
module for Omeka S. It allows administrators to build forms for public sites.
...
The complete documentation of Formularium can be found at
https://biblibre.github.io/omeka-s-module-Formularium/
...
Formularium is distributed under the GNU General Public License, version 3 (GPLv3).
