 ...
 */
class FormulariumFormActionResult extends \Formularium\Entity\FormulariumFormActionResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormulariumFormActionResult $proxy) {
