 ...
 */
class FormulariumForm extends \Formularium\Entity\FormulariumForm implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormulariumForm $proxy) {
